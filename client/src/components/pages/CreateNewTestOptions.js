...
export default function CreateNewTestOptions() {
    ...
    return (
        ...
        <div>
            ...
            <Link to="/" className="btn btn-light">Generate Random Texts and Choose Visualizations </Link><br/><br/>
            <Link to="/" className="btn btn-light">Generate Random Texts and random Visualizations</Link><br/><br/>
